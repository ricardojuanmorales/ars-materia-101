...
15. Gramática editorial reconocible = control de deriva, no clonación formal.
...
> **Carril A H7 activo. Próximo control: FEHE-H7 profunda CANDIDATA → Gate FEHE-H7.**
...
## 13. D-043 · cierre H6 y retorno a Carril A

```text
→ H6 PRODUCIDO, MONTADO Y VERIFICADO EN MOODLE · D-042
→ Auditoría Inversa H6 COMPLETADA
→ Gate Integral H6 · GO CON CONDICIONES · D-043
...
Condiciones D-043 son no bloqueantes y permanecen en backlog controlado.

Orientación H7:

> **La industria inventa nuevos materiales · SINTETIZAR Y REPRODUCIR**

Reserva longitudinal:
...
## 17. Paso 1 H7 completado · Gate de Realización

```text
OVAt-H7 APROBADO · D-045
→ Paso 1 de Realización H7 v1.0 COMPLETADO
→ Gate de Realización H7 ABIERTO
→ [decisión humana]
→ si REALIZACIÓN APROBADA / APROBADA CON AJUSTES sin bloqueantes
→ activar Carril B H7
→ F1
...
Carril B permanece cerrado hasta decisión humana.


## 18. D-046 · Realización H7 aprobada

```text
FEHE-H7 APROBADA · D-044
→ OVAt-H7 APROBADO · D-045
→ Paso 1 de Realización H7 APROBADO · D-046
→ Carril B H7 ACTIVO
→ F1 Bienvenida H7
