...
**Producto reusable:** Ficha Inicial del Caso A → Portafolio de Casos Ars Materia  
**Valor:** 3 puntos  
...
Ya trabajaste dos movimientos fundamentales de Ars Materia:
...
> **¿Qué caso material propondrías para investigar cómo las decisiones de selección, preparación y transformación dejan evidencia sobre el conocimiento material de una sociedad, comunidad o práctica artística?**

---

# Parte 1 · Publicación inicial: funda tu Caso A

Redacta una propuesta breve y argumentada que incluya:

1. **Identificación del caso.** Explica qué objeto, conjunto, práctica o sistema material estudiarías y ubícalo brevemente en tiempo y lugar.
...
La extensión es una guía de economía y claridad. El objetivo no es llenar espacio, sino delimitar bien el caso.

---

# Parte 2 · Revisión analítica a un compañero
...
- propone una variable de proceso que debería considerar;
- identifica una explicación alternativa;
- añade un límite o incertidumbre;
- explica por qué el caso podría necesitar mayor delimitación;
- señala qué parte del caso parece especialmente fértil para volver a estudiarse más adelante.
...
- ¿Estoy explicando qué evidencia necesitaría y para qué?
...
# Criterios de evaluación · 3 puntos

| Criterio | Evidencia esperada | Puntos |
|---|---|---:|
| **Caso y problema material** | Identifica y delimita un caso contextualizado y formula un problema material claro que integra selección/preparación y transformación. | 1.0 |
| **Evidencia, inferencia y límite** | Propone evidencia pertinente, explica qué permitiría investigar, formula una inferencia proporcionada y reconoce un límite explícito. | 1.0 |
| **Interacción analítica y transferibilidad** | La respuesta a un compañero añade evidencia, contraste, variable, límite o revisión significativa y muestra comprensión de cómo fortalecer un caso. | 1.0 |
| **Total** |  | **3.0** |

## Referencia rápida de desempeño

**Logro completo:** el caso está bien delimitado, integra H1+H2, vincula evidencia con inferencia, reconoce límites y la respuesta al compañero mejora el razonamiento.

**Logro parcial:** el caso es pertinente, pero alguna relación entre materia, proceso, evidencia, inferencia o límite queda poco desarrollada.

**Insuficiente:** predomina el resumen del objeto o periodo, el caso es demasiado amplio, la evidencia no se relaciona con afirmaciones concretas o las conclusiones exceden lo que la evidencia permitiría sostener.
...
- [ ] Mi caso es identificable y está delimitado.
- [ ] Integré selección/preparación de H1 y transformación de H2.
- [ ] Propuse al menos dos tipos de evidencia y expliqué para qué servirían.
- [ ] Distinguí evidencia de inferencia.
- [ ] Incluí una incertidumbre o límite real.
- [ ] Evité atribuir automáticamente ciencia contemporánea a actores históricos.
- [ ] Mi respuesta al compañero añade análisis.
- [ ] Conservé esta propuesta como **Ficha Inicial del Caso A** para mi Portafolio de Casos.

---

# Producto del nodo

> **Ficha Inicial del Caso A**

Tu publicación de FD1 constituye la primera versión de tu caso ancla. No tendrás que rehacerla desde cero si el caso vuelve más adelante. Podrás revisarla, profundizarla, contrastarla o retirarla si deja de ser pedagógicamente fértil.

---

# Citación sugerida

Morales De Jesús, R. J. (2026). *FD1 · Caso Ancla A: Fundar un caso material H1+H2* [Foro de discusión]. CIFI 4074 · Ars Materia.

# Uso de IA

Actividad desarrollada por el profesor con apoyo de ChatGPT (OpenAI) para organización, edición y síntesis. El contenido académico, los criterios de evaluación, la arquitectura de la Espiral de Casos y la versión final permanecen bajo responsabilidad docente.
...
Dimensiones que avanzan en FD1:

- definición del caso;
- evidencia;
- inferencia;
- límite/autonomía inicial.

Dimensiones que permanecen deliberadamente andamiadas:
